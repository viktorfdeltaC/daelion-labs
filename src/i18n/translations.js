export const translations = {
  de: {
    ...
    modal_message_placeholder: 'Beschreibe kurz dein Projekt oder Problem.',
    modal_submit:         'Anfrage senden →',
    modal_success_title:  'Danke!',
    modal_success_body:   'Wir melden uns innerhalb von 24 Stunden.',
    modal_error:          'Etwas ist schiefgelaufen. Bitte versuche es erneut oder schreib uns direkt an hello@daelionlabs.com',
    ...
    modal_budget:       'Budget',
    modal_budget_u1k:   'Unter 1.000 €',
    modal_budget_1_3k:  '1.000 – 3.000 €',
    modal_budget_3_8k:  '3.000 – 8.000 €',
    modal_budget_8kp:   '8.000 € +',
    modal_budget_open:  'Noch offen',
    modal_timeline:     'Zeitrahmen',
    modal_timeline_asap: 'So schnell wie möglich',
  ...
  en: {
    ...
    modal_message_placeholder: 'Briefly describe your project or problem.',
    modal_submit:         'Send request →',
    modal_success_title:  'Thank you!',
    modal_success_body:   'We will get back to you within 24 hours.',
    modal_error:          'Something went wrong. Please try again or write to us directly at hello@daelionlabs.com',
    ...
    modal_budget:       'Budget',
    modal_budget_u1k:   'Under €1,000',
    modal_budget_1_3k:  '€1,000 – €3,000',
    modal_budget_3_8k:  '€3,000 – €8,000',
    modal_budget_8kp:   '€8,000 +',
    modal_budget_open:  'Not yet decided',
    modal_timeline:     'Timeline',
    modal_timeline_asap: 'As soon as possible',
